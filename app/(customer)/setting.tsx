...
export default function Settings() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ Profil */}
      <TouchableOpacity style={styles.menuItem} onPress={() => router.push("/customer")}>
      ...
      {userRole === "driver" && (
        <TouchableOpacity style={styles.menuItem} onPress={handleConvertToRider}>
          ...
          <Text style={styles.menuText}>Convert to Rider</Text>
        </TouchableOpacity>
      )}
      ...
      {/* ✅ Complain */}
      <TouchableOpacity style={styles.menuItem} onPress={handleComplain}>
